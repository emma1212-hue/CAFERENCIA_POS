...
<body>
    <div class="main-container">
        ...
        <div class="search-form">
            <div class="form-header">
                <h1><i class="fas fa-search"></i> Consultar Productos</h1>
                <p>Busque productos por ID o nombre</p>
            </div>
            ...
            <form method="GET" action="" class="search-form">
                <div class="search-grid">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" class="btn-info" onclick="location.href='consultar_insumos.php'">
                            Gestionar Insumos
                        </button>
            ...
            if (!empty($buscarId) || !empty($buscarNombre)) {
                ...
                if ($totalResultados > 0) {
                    echo "Se encontraron <strong>$totalResultados</strong> producto(s)";
                } else {
        ...
        <div class="table-section">
            <div class="table-panel">
                <div class="table-header">
                    <h2><i class="fas fa-boxes"></i> Resultados de la Búsqueda</h2>
                    <div class="table-stats">
                        <?php echo $totalResultados; ?> producto(s)
                    </div>
                </div>
    ...
    <script>
        ...
        function limpiarBusqueda() {
            window.location.href = 'consultar_productos.php';
        }
