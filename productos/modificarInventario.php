...
<body>
    <div class="main-container">
        ...
        if (isset($_GET['success'])) {
            echo '<div class="alert alert-success">
                    <i class="fas fa-check-circle"></i> Insumo modificado correctamente
                  </div>';
        }
        ...
        <!-- Formulario de Modificación de Inventario -->
        <div class="form-section">
            <div class="form-panel">
                <div class="form-header">
                    <h1>Modificar Insumo</h1>
                    <p>Seleccione un insumo de la tabla y modifique la información</p>
                </div>

                <form action="php/actualizar_inventario.php" method="POST" class="user-form" id="inventarioForm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-column-right">
                            <div class="form-group">
                                ...
                                <input type="text" id="unidad" name="unidad" placeholder="Ej: Piezas" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-column-left">
                            <div class="form-group">
                                ...
                                <textarea id="descripcion" name="descripcion" placeholder="Descripción detallada del insumo..." required></textarea>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" class="btn btn-info" onclick="location.href='modificar_productos.php'">
                            Gestionar Productos
                        </button>
                    </div>
                </form>
                    ...
                    <table class="users-table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT i.idInventario, i.nombre, i.descripcion, i.unidad, 
                                   i.stockActual, i.costoUnitario, i.idCategoria, c.nombre as categoria 
                            FROM inventario i 
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<tr class='inventory-row' onclick='cargarInsumo({$row['idInventario']}, \"{$nombreEscapado}\", \"{$descripcionEscapada}\", \"{$unidadEscapada}\", {$row['stockActual']}, {$row['costoUnitario']}, {$row['idCategoria']})'>
    ...
    <script>
        ...
        function cargarInsumo(idInventario, nombre, descripcion, unidad, stockActual, costoUnitario, idCategoria) {
            ...
            function verificarNombreInsumo(nombre) {
                ...
                .then(data => {
                    if (data.existe) {
                        ...
                        nombreValidacion.className = 'validation-message validation-error';
                        disableSubmitButton();
                    } else {
